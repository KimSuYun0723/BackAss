...
SECRET_KEY = 'django-insecure-wwzp*m=0+(tnc@5**8_60kao6+=n%2i_dzv4q&rnw2d6n+ln0^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['https://port-0-python-django-kvmh2mljv9n1pe.sel4.cloudtype.app', '127.0.0.1']
